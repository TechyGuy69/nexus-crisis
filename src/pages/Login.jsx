      ...
      <div style={{
        ...
        <div style={{ width: "100%", maxWidth: 380 }}>
          ...
          <div style={{ textAlign: "center", marginBottom: 32 }}>
            ...
            }}>BYTE CLUB PVT LTD · STAFF ACCESS</div>
          </div>
          ...
          <div style={{
            ...
            <p style={{ color: "var(--text3)", fontSize: 13, marginBottom: 24 }}>
              Access the crisis command center
            </p>

            {[
              { label: "EMAIL", val: email, set: setEmail, type: "email", placeholder: "staff@byteclubhotel.com" },
            ...
            <div style={{
              ...
              Demo: staff@byteclubhotel.com<br />
              Password: nexus2024
            </div>
          </div>
        </div>
